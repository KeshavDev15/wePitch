  ...
  return (
    <form action={formAction} className='startup-form'>
        ...
        <div>
            ...
            <Input id='category' name='category' placeholder='Startup Category (Tech,Health,Education ....)' className='startup-form_input' required />
            {errors.category && <p className='startup-form_error'>{errors.category}</p>}
        </div>
        <div>
            <label htmlFor="link" className='startup-form_label'>Image URL</label>
            <Input id='link' name='link' placeholder='Startup Image URL' className='startup-form_input' required />
